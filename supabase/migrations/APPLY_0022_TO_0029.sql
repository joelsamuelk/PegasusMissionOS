-- =====================================================================
-- Pegasus Mission OS: migrations 0022 to 0029, consolidated
--
...
--   0029  The only unauthenticated surface: `anon` may read a public, open,
--         published form and nothing else, and write only through one
--         security-definer function that classifies answers itself
--
...
-- =====================================================================
-- 0029_public_form_access.sql
-- The anonymous surface: public form policies and the one definer function
-- =====================================================================
