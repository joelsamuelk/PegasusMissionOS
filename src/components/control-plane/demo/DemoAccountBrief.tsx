/**
 * The demonstration account brief.
 *
 * Reads the curated example accounts, so it renders only when `ctx.demoMode`
 * is true. A real prospect's brief is its record under /control/prospects.
 */
...
export async function DemoAccountBrief({
  params,
}: {
